function P0018 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   P0018 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   P0018 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   P0018 = importfile('P001_8.lst', 9, 8347);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/02/01 10:03:11
